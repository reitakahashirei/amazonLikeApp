<nav class="navbar navbar-expand-md navbar-light shadow-sm amazon-header-container">
    ...
    <form class="form-inline">
        <div class="form-group">
            <input class="form-control amazon-header-search-input">
        </div>
        <div class="input-group">
            <button type="submit" class="btn amazon-header-search-button"><i class="fas fa-search amazon-header-search-icon"></i></button>
        </div>
    </form>
